 ...
 * then the control is transferred to the main try block (outer try block) where the 
 * appropriate catch block handles the exception. It is termed as nesting.
 * */

public class NestedTryCatchAnotherExample {
